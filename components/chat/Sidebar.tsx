    ...
    <div className="flex flex-col gap-0.5">
      {Array.from({ length: 3 }).map((_, index) => (
        <div className="flex h-9 items-center gap-2 rounded-lg px-1 py-1.5" key={index}>
          ...
          <div className="h-4 flex-1 animate-pulse rounded-md bg-gray-200/70" />
        </div>
      ))}
    </div>
  );
    ...
    >
      <div className="flex h-full flex-col" style={{ width }}>
        ...
        <div className="mb-6 mt-2 px-4">
          <button
            className="group flex h-9 w-full items-center justify-center gap-2 rounded-lg bg-[#f3f4f5] px-3 text-sm font-medium text-gray-900 transition-colors hover:bg-[#eceef0]"
            onClick={onNewChat}
            type="button"
          >
            <Plus size={20} />
                ...
                >
                  <div
                    className={cn(
                      ...
                      active ? 'bg-[#eceef0] text-gray-900' : 'text-gray-700 hover:bg-[#f0f1f2]',
                    )}
                    onKeyDown={(event) => {
                  ...
                  >
                    ...
                    {loading ? (
                      ...
                      <button
                        className={cn(
                          'flex h-7 w-7 shrink-0 items-center justify-center rounded-md text-gray-400 opacity-0 transition-opacity hover:bg-gray-200 hover:text-gray-800 group-hover:opacity-100',
                  ...
                  {menuOpen && (
                    <div className="absolute right-1 top-8 z-50 min-w-36 overflow-hidden rounded-lg border border-gray-200 bg-white py-1 text-sm shadow-[0_12px_32px_rgba(0,0,0,0.12)]">
                      <button
                        className="flex h-8 w-full items-center gap-2 px-2.5 text-left text-gray-700 transition-colors hover:bg-gray-100"
                        onClick={() => {
                          setOpenSessionMenuId(null);
                      ...
                      <button
                        className="flex h-8 w-full items-center gap-2 px-2.5 text-left text-red-600 transition-colors hover:bg-red-50"
                        onClick={() => {
                          setOpenSessionMenuId(null);
