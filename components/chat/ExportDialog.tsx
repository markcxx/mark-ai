...
export function ExportDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/35 p-3 backdrop-blur-sm md:p-6">
      <div className="flex max-h-[92dvh] w-full max-w-6xl flex-col overflow-hidden rounded-xl border border-gray-200 bg-white shadow-[0_24px_80px_rgba(0,0,0,0.24)] dark:border-white/10 dark:bg-[#191919]">
        <div className="flex h-14 shrink-0 items-center justify-between border-b border-gray-200 px-4 dark:border-white/10">
          <div className="flex min-w-0 items-center gap-2">
            <span className="truncate text-base font-semibold text-gray-950 dark:text-gray-50">
              导出会话
            </span>
          ...
          <button
            className="flex h-9 w-9 items-center justify-center rounded-lg text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-950 dark:text-gray-400 dark:hover:bg-white/[0.06] dark:hover:text-white"
            onClick={onClose}
            title="关闭"
            type="button"
          >
        ...
        <div className="grid min-h-0 flex-1 grid-rows-[auto_minmax(0,1fr)_auto] md:grid-cols-[minmax(0,1fr)_280px] md:grid-rows-1">
          ...
          <div className="flex shrink-0 flex-col gap-3 border-t border-gray-200 p-4 dark:border-white/10 md:border-l md:border-t-0">
            ...
            <div className="text-sm leading-6 text-gray-500 dark:text-gray-400">
              图片会按左侧预览导出，保留聊天气泡、Markdown 样式和底部 MARKAI 标识。JSON 会导出完整结构化数据。
            </div>
            ...
            <div className="mt-auto grid grid-cols-2 gap-2 md:grid-cols-1">
              ...
              <button
                ...
                type="button"
              >
                {imageLoading ? <Download className="animate-pulse" size={16} /> : <ImageDown size={16} />}
