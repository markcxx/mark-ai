...
export function ThinkingPanel({
  ...
  const expanded = Boolean(
    thinkingDisplay === "expanded" || (thinkingDisplay === "auto" && thinking) || showDetail,
  );
      ...
      >
        <span
          className={cn(
            ...
            expanded &&
              !thinking &&
              "border-purple-200 dark:border-purple-800 bg-purple-50 dark:bg-purple-900/30 text-purple-500 dark:text-purple-400",
          )}
        >
