...
export function GuestChatApp() {
  ...
  return (
    <div className="flex h-dvh w-screen flex-col overflow-hidden bg-[var(--chat-app-bg)] text-gray-900 dark:text-gray-100">
      <AnnouncementBar />
      <div className="flex min-h-0 flex-1 overflow-hidden p-0 md:p-2">
        ...
        <main className="relative flex min-w-0 flex-1 flex-col overflow-hidden bg-[var(--chat-panel-bg)] md:rounded-xl md:border md:border-gray-200 dark:md:border-white/10">
          <header className="flex h-14 shrink-0 items-center justify-between px-3 md:h-16 md:px-6">
            ...
            <div className="flex items-center gap-1">
              <Link
                href="/download"
                className="inline-flex h-11 items-center rounded-lg px-3 text-sm font-medium hover:bg-gray-100 dark:hover:bg-white/[0.07]"
              >
                下载 App
              </Link>
