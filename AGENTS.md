...
- OpenAI-compatible providers may return reasoning either in structured fields such as `reasoning_content` or embedded inside content with `<think>...</think>` tags.
